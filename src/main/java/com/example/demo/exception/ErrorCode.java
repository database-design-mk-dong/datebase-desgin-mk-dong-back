...
public enum ErrorCode {
    ...
    NOT_FOUND_CROP(40404, HttpStatus.NOT_FOUND, "작물 존재 안함."),
    NOT_FOUND_ENVIRONMENT(40405, HttpStatus.NOT_FOUND, "환경이 존재하지 않음"),
    NOT_FOUND_FARM(40405, HttpStatus.NOT_FOUND, "농장이 존재하지 않음"),
    NOT_FOUND_FARMDEVICE(40405, HttpStatus.NOT_FOUND, "농장의 디바이스가 존재하지 않음"),
    NOT_FOUND_DEVICE(40405, HttpStatus.NOT_FOUND, "디바이스가 존재하지 않음"),
    ...
    EXIST_BY_USERNAME(40009, HttpStatus.BAD_REQUEST, "이름 겹침"),
    BAD_REQUEST_PASSWORD(40010, HttpStatus.BAD_REQUEST, "비밀번호 틀림"),
